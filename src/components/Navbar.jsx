  ...
  return (
    <div className="flex items-center justify-between mx-4 py-3 lg:mx-44 bg-slate-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Sign Up Button */}
        <button className="bg-zinc-800 dark:bg-zinc-200 text-white dark:text-gray-900 px-4 py-2 sm:px-7 sm:py-2.5 text-sm rounded-2xl transition-all duration-300 hover:bg-zinc-700 dark:hover:bg-zinc-300">
          Sign Up
        </button>
      </div>
    </div>
